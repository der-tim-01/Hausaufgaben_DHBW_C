...
void loadList(listElement *start){
	...
	system("dir *.txt"); // ls /b *.txt for windowsgnuplot
        ...
        do{
            ...
            for (i = 0; i < lenOfList - 1; i++){
                    ...
                    case 1: // last name 
                        ...
                        strcpy(temp1, (prevElem->nextElem)->lastName);
                    ...
                    case 2: // first name   
                        ...
                        strcpy(temp1, (prevElem->nextElem)->firstName);
                    ...
                    case 3: // age  
                        ...
                        if((prevElem->nextElem)->age > (currElem->nextElem)->age) swapFLAGG = 1;
                        /* ---------------- 
                        Do the preprocessing:
